...
// document.addEventListener('DMoCon')
...
//     // console.log(this)
//     // var stopTime = new Date(stopTimer)
...
var FlipDown = function () {
    ...
    _createClass(FlipDown, [{
        ...
        value: function start() {
            if (!this.initialised) var a = this._init();
        ...
        value: function _tick() {
            // console.log(this.element)
            if (this.element.time)
                this.uts = new Date(this.element.time.stopTime)
            this.now = this._getTime();
